...
try: 
    ...
    librwalk = npct.load_library("rwalk", libfile)
    librwalk.biased_random_walk.restype = None
    librwalk.biased_random_walk.argtypes = [array_1d_int, array_1d_int, c_int, c_int, c_int, 
                                            c_double, c_double, c_int, c_int, array_1d_int]
    logging.warn(f"Successfully loaded rwalk library from: {libfile}")
except:
    logging.warn(f"Failed loading rwalk library, using a slower native implementation.")
    LIBWALK = False
    pass
